...
function ensureReorderModal() {
  ...
  modal.innerHTML = `
    <div class="bg-white rounded-lg shadow-xl w-full max-w-3xl flex flex-col overflow-hidden" style="height: 90vh; max-height: 90vh;">
      ...
      <div class="p-5 flex-1" style="overflow-y: auto; min-height: 0;">
